...
<div class="page-hero d-flex align-items-center justify-content-between flex-wrap gap-2">
    <div>
        <h1><i class="bi bi-people me-2" style="color:var(--pos-primary)"></i>Staff & Employee Management</h1>
        <p>Manage employees eligible for credit sales, track pending payments, and manage cashier accounts.</p>
    </div>
...
<div class="row g-3 mb-4">
    ...
    <div class="col-6 col-lg-3">
        <div class="stat-card">
            ...
            <div>
                <div class="stat-label">Pending Dues to Clear</div>
    ...
    <div class="col-6 col-lg-3">
        <div class="stat-card">
            ...
            <div>
                <div class="stat-label">Total Credit Recovered</div>
                <div class="stat-value">{{ pkr($stats['total_paid'], 2) }}</div>
    ...
    <div class="col-6 col-lg-3">
        <div class="stat-card">
            ...
            <div>
                ...
                <div class="stat-sub">POS system operators</div>
            </div>
        </div>
    </div>
</div>
        ...
        <table class="pos-table w-100">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <span style="background:#ede9fe; color:#6d28d9; border-radius:12px; padding:2px 8px; font-size:11px; font-weight:700;">
                            POS Cashier
                        </span>
                    </td>
                    <td>
